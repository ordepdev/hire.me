...
class EducationsControllerTest < ActionController::TestCase
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post :create, education: { course: @education.course, graduation_date: @education.graduation_date, school: @education.school, title: @education.title, user_id: @education.user_id }
    end
  ...
  test "should update education" do
    put :update, id: @education, education: { course: @education.course, graduation_date: @education.graduation_date, school: @education.school, title: @education.title, user_id: @education.user_id }
    assert_redirected_to education_path(assigns(:education))
  end
